...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(my_todo command_execution_time background_jobs status my_ip)

POWERLEVEL9K_MY_IP_BACKGROUND="$EMPTY_BG"
POWERLEVEL9K_MY_IP_FOREGROUND="006"

POWERLEVEL9K_MY_TODO_BACKGROUND="$EMPTY_BG"
POWERLEVEL9K_MY_TODO_FOREGROUND="red"
...
POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND="ciano"
