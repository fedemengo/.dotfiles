...
POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR="%F{$DEFAULT_BG}|%f"
POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR=""
POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR="%F{$DEFAULT_BG}|%f"
...
POWERLEVEL9K_HISTORY_FOREGROUND="$DEFAULT_FG"

# here
POWERLEVEL9K_TIME_FORMAT="%D{%H:%M}" #  15:29:33
POWERLEVEL9K_TIME_FOREGROUND="$DEFAULT_BG"
...
# here
POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND="$DEFAULT_BG"
POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND="$EMPTY_BG"

POWERLEVEL9K_USER_ICON="\uF415" # 
POWERLEVEL9K_USER_DEFAULT_FOREGROUND="$DEFAULT_FG"
POWERLEVEL9K_USER_DEFAULT_BACKGROUND="$DEFAULT_BG"
POWERLEVEL9K_USER_ROOT_FOREGROUND="$DEFAULT_FG"
POWERLEVEL9K_USER_ROOT_BACKGROUND="$DEFAULT_BG"

POWERLEVEL9K_ROOT_INDICATOR_FOREGROUND="$DEFAULT_FG"
POWERLEVEL9K_ROOT_INDICATOR_FOREGROUND="magenta"
POWERLEVEL9K_ROOT_INDICATOR_BACKGROUND="$DEFAULT_BG"
POWERLEVEL9K_ROOT_INDICATOR_BACKGROUND="$(( $DEFAULT_BG + 2 ))"
POWERLEVEL9K_ROOT_INDICATOR_BACKGROUND="$(( $DEFAULT_BG - 2 ))"
#POWERLEVEL9K_ROOT_ICON=$'\uFF03' # ＃
POWERLEVEL9K_ROOT_ICON=$'\uF198'  # 

POWERLEVEL9K_SSH_FOREGROUND="$DEFAULT_FG"
POWERLEVEL9K_SSH_FOREGROUND="yellow"
POWERLEVEL9K_SSH_BACKGROUND="$DEFAULT_BG"
POWERLEVEL9K_SSH_BACKGROUND="$(( $DEFAULT_BG + 2 ))"
POWERLEVEL9K_SSH_BACKGROUND="$(( $DEFAULT_BG - 2 ))"
POWERLEVEL9K_SSH_ICON="\uF489"  # 

POWERLEVEL9K_HOST_LOCAL_FOREGROUND="$DEFAULT_FG"
POWERLEVEL9K_HOST_LOCAL_BACKGROUND="$DEFAULT_BG"
POWERLEVEL9K_HOST_REMOTE_FOREGROUND="$DEFAULT_FG"
POWERLEVEL9K_HOST_REMOTE_BACKGROUND="$DEFAULT_BG"

POWERLEVEL9K_HOST_ICON_FOREGROUND="$DEFAULT_FG"
POWERLEVEL9K_HOST_ICON_BACKGROUND="$DEFAULT_BG"
POWERLEVEL9K_HOST_ICON="\uF109" # 

POWERLEVEL9K_OS_ICON_FOREGROUND="$DEFAULT_FG"
POWERLEVEL9K_OS_ICON_BACKGROUND="$DEFAULT_BG"

POWERLEVEL9K_LOAD_CRITICAL_BACKGROUND="$DEFAULT_BG"
POWERLEVEL9K_LOAD_WARNING_BACKGROUND="$DEFAULT_BG"
POWERLEVEL9K_LOAD_NORMAL_BACKGROUND="$DEFAULT_BG"
...
POWERLEVEL9K_BATTERY_LEVEL_BACKGROUND_COLOR="$DEFAULT_BG"
POWERLEVEL9K_BATTERY_CHARGING_BACKGROUND="$DEFAULT_BG"
POWERLEVEL9K_BATTERY_CHARGED_BACKGROUND="$DEFAULT_BG"
POWERLEVEL9K_BATTERY_DISCONNECTED_BACKGROUND="$DEFAULT_BG"
